namespace Modbus.FunctionParameters
{
	...
	/// Base class who define static part of bytest 
	/// 1. Transaction ID - num of transaction 
	/// 2. Protocol ID - id of protocol comunication (modbus) 
	/// 3. Length - of message 
	/// 4. Unitid 
	/// 5. Function code - giving info of signal (Digital,analog...) 
    /// </summary>
